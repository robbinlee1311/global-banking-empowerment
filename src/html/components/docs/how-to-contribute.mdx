# Contributing to Global Banking Empowerment
...
1. Contribution Requirements :
    * When you contribute, you agree to give a non-exclusive license to Global Banking Empowerment.io to use that contribution in any context as we (Global Banking Empowerment.io) see appropriate.
...
2. Installation :
    ...
    * Clone to your machine
    ...
    ```bash
    git clone https://github.com/YOUR_USERNAME/global-banking-empowerment.git
    ```
...
- clone the `Global Banking Empowerment` repo.
