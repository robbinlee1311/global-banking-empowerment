Global Banking Empowerment ships an RTL (right-to-left) stylesheet alongside the standard LTR one, generated from the same source via [`rtlcss`](https://rtlcss.com/). Use it for Arabic, Hebrew, Persian, Urdu, and any other right-to-left scripts.
...
```text
dist/css/GlobalBankingEmpowerment.css           ← LTR (default)
dist/css/GlobalBankingEmpowerment.rtl.css       ← RTL
dist/css/GlobalBankingEmpowerment.min.css
dist/css/GlobalBankingEmpowerment.rtl.min.css
```
...
<html lang="ar" dir="rtl">
  <head>
    <link rel="stylesheet" href="dist/css/GlobalBankingEmpowerment.rtl.min.css" />
  </head>
...
Bootstrap and Global Banking Empowerment handle nested direction switches correctly — the inner element's direction is what counts.

##### Building RTL yourself

If you're building Global Banking Empowerment from source and you've modified the SCSS, regenerate the RTL CSS:
